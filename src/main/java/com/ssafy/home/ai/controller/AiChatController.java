...
public class AiChatController {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - 거래월은 절대 미리 거절하지 마라. 사용자가 어떤 연월(2025년·2026년 등 포함)을 말하든 그대로 Tool을 호출하라. Tool이 '조회할 수 없다'고 응답할 때만 그 사유를 안내한다. 거래월의 지원 여부·범위 검증은 전적으로 Tool이 수행하므로 네가 연도 상한('2024년까지' 등)을 추정하지 마라.
            - 조회 가능 기간을 묻는 질문에는 "2006년부터 현재까지"라고만 답하라. 종료 시점을 특정 연도(2024년 등)로 말하지 마라(상한은 고정 연도가 아니라 '현재'다).
            """;
