...
## 문서
- [2026-06-22 남은 작업 백로그 (재편성)](2026-06-22-backlog.md) — `type: report`, **진행 중 (남은 작업 단일 출처)**
- [2026-06-21 최종 인계 / 재개 가이드](2026-06-21-handoff.md) — `type: report`, **다른 환경에서 이어받을 때 먼저 읽기**
- [2026-06-21 남은 작업 백로그](2026-06-21-backlog.md) — `type: report`, 2026-06-21 스냅샷 (superseded, 완료 이력)
